...
class DBCGenerator:
    ...
    # def changeSignal(self, frame_id):
    #     for messages in self.DBC._messages:
    #         if messages._frame_id ==frame_id:
    #             #need to add changes to signals or message parameters
...
if __name__ == "__main__":
    ...
    generator = DBCGenerator("DBCFiles/J1939 DBC/j1939_DBC_EXAMPLE.dbc")
